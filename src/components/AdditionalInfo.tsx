        ...
        <div className="border border-blue-500/30 rounded-lg p-5 bg-gray-800/50 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input className={inputClass} placeholder="e.g. Light Vehicle - Automatic, Heavy vehicle- Manual " value={form.driving_license_category} onChange={e => set('driving_license_category', e.target.value)} maxLength={20} />
            </div>
            <div>
