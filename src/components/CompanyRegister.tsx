    ...
    return (
      <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 px-4">
        <div className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 p-8 text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">Your company profile has been created. You can now post jobs and training listings.</p>
      ...
      <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 px-4">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-center text-xs text-gray-600 mt-6">
            Already have a company profile? <Link to="/" className="text-blue-500 hover:text-blue-400">Sign in</Link>
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-900 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          <button onClick={() => setStep('access')} className="text-gray-400 hover:text-white">←</button>
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl border border-gray-700 p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea className={inputClass} rows={3} placeholder="Brief description of your company and what you specialise in..." value={form.about} onChange={e => set('about', e.target.value)} maxLength={300} />
